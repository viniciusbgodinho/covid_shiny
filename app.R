...
ui <- bootstrapPage(
    navbarPage(theme = shinytheme("flatly"), collapsible = TRUE,
               ...
               tabPanel("Graficos por Local",
                        
                        sidebarLayout(
                            sidebarPanel(
                                
                                span(tags$i(h6("Selecione para visualizar os graficos para o Brasil, grandes Regioes, Estados e Capitais.")), style="color:#045a8d"),
                                ...
                                "Dados das Secretarias Estaduais de Saude via projeto https://brasil.io/covid19/"
                            ),
                            ...
                            mainPanel(
                                tabsetPanel(
                                    ...
                                    tabPanel("Media Movel 7 dias", plotlyOutput("ma7_plot")),
